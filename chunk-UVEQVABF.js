...
var Game = class {
  ...
  static loop() {
    ...
    if (Keyboard.isPressed("ctrl", "f1")) {
      ...
      import("./Debugger-K3QWKXJT.js").then((x) => {
        console.log(x);
        x.default.start();
